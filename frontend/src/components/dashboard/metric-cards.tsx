...
export function MetricCards({ totalEmissions, scope1, scope2, scope3 }: MetricCardsProps) {
    const metrics = [
        {
            title: "Total Emissions",
            value: totalEmissions ? (totalEmissions / 1000).toFixed(1) + "k" : "12,847",
            unit: "tCO₂e",
            change: -8.2,
        ...
        {
            title: "Scope 1",
            value: scope1 ? (scope1 / 1000).toFixed(1) + "k" : "3,421",
            unit: "tCO₂e",
            change: -12.5,
            changeLabel: "vs last year",
            icon: Flame,
        ...
        {
            title: "Scope 2",
            value: scope2 ? (scope2 / 1000).toFixed(1) + "k" : "6,892",
            unit: "tCO₂e",
            change: -5.3,
            changeLabel: "vs last year",
            icon: Factory,
        ...
        {
            title: "Scope 3",
            value: scope3 ? (scope3 / 1000).toFixed(1) + "k" : "2,534",
            unit: "tCO₂e",
            change: 2.1,
            changeLabel: "vs last year",
            icon: Truck,
