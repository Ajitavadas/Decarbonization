...
const activities = [
    {
        ...
        type: "upload",
        title: "CSV Uploaded",
        description: "Emissions data file uploaded for Q1 2025 project",
        time: "2 min ago",
        icon: FileUp,
    ...
    },
    {
        ...
        description: "All scopes calculated using Climatiq emission factors",
        time: "15 min ago",
        icon: RefreshCw,
    ...
    },
    {
        ...
        description: "AI identified potential data quality improvements",
        time: "1 hour ago",
        icon: MessageSquare,
    ...
    },
    {
        ...
        type: "verification",
        title: "Data Verified",
        description: "Activity data passed validation checks",
        time: "3 hours ago",
        icon: Check,
        iconColor: "text-primary",
    },
